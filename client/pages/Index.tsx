      ...
      >
        <div className="w-full overflow-visible">
          <div className="container-custom text-center mb-8">
            <h2 className="font-serif text-4xl lg:text-6xl text-brown mb-8">/We Make Launching Feel Easy</h2>
          </div>
        ...
        <div className="container-custom text-center">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="font-serif text-gray-blue italic mb-12 sm:mb-16">
              ...
              <div className="hero-text-line-1 text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl leading-relaxed sm:leading-tight mb-3 sm:mb-4">
                Most founders we meet have <span className="font-luxurious text-xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl not-italic pr-3">Great Ideas</span>
              </div>
              ...
              <div className="hero-text-line-3 text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl leading-relaxed sm:leading-tight">
                <span className="hero-with-paid-users block sm:inline mt-1 sm:mt-0 text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl">
